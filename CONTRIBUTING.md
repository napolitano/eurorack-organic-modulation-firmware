...
1. run the native test suites and sanitizers for all seven compile-time banks present on `main` (Classic, Organic, Generative, Ambient, Electronica, Percussion and Dubstep/Bass);
