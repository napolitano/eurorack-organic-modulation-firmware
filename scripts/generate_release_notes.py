...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--banks", default="classic,organic,generative,ambient,electronica", help="Comma-separated banks included in the release")
...
def render_notes(*, text: str, tag: str, repository: str, server_url: str, previous_tag: str = "", banks: tuple[str, ...] = ("classic", "organic", "generative", "ambient", "electronica")) -> str:
...
def main() -> int:
    ...
    try:
        ...
        if not banks or any(bank not in ("classic", "organic", "generative", "ambient", "electronica") for bank in banks):
