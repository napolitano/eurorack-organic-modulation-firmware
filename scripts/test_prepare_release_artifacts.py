...
def main() -> int:
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        try:
            ...
            output_dir.mkdir()
            banks = release.parse_banks("classic,organic,generative,ambient")
            ...
            assert "Classic" in text and "Organic" in text and "Generative" in text and "Ambient" in text
