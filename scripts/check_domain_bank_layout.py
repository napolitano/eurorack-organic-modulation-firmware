...
BANK_MEMBERS = {
    ...
    "dubstep": (
        "WobbleAlgorithm", "GrowlAlgorithm", "ChopAlgorithm", "BuildAlgorithm", "DubstepAlgorithmMath",
    ),
}
...
def main() -> None:
    ...
    print("domain-bank-layout: seven bank directories and qualified includes passed")
